...
<head>
    ...
    <style>
        ...
        .btn-back { position: absolute; top: 20px; left: 20px; padding: 8px 20px; border: 1px solid #ccc; background: #fff; text-decoration: none; color: #333; border-radius: 5px; font-size: 14px; }
...
<body>
    <a href="admin.php" class="btn-back">Powrót</a>
    <div class="container">
