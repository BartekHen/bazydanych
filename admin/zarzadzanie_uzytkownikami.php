...
$szukano = false; // Flaga sprawdzająca czy wykonano próbę wyszukiwania
...
if (isset($_GET['szukaj_btn'])) {
    ...
    // Szukamy tylko wśród uczniów i rodziców
...
<head>
    <meta charset="UTF-8">
    <title>Zarządzanie kontami użytkowników</title>
    <style>
    ...
    <div style="text-align: left; max-width: 800px; margin: 0 auto;">
        ...
        <?php if ($szukano): ?>
            ...
            <?php elseif (!$wybrany_uzytkownik): ?>
                <div class="search-error">Nie znaleziono użytkownika o podanych danych.</div>
            <?php endif; ?>
        <?php endif; ?>
    </div>
